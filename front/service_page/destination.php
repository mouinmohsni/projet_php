...
$lise_destination = $destination->geAllDestinations();
		...
		<section id="explore" class="explore">
			<div class="container">
				...
				<div class="explore-content">
					<div class="row">
						<?php
						while ($one_destination = $lise_destination->fetch()){
							?>
							<div class="col-md-4 col-sm-6">
								<div class="single-explore-item">
									<div class="single-explore-img">
										<img src="../assets/images/<?php echo $one_destination['url_image']; ?>" alt="explore image">
									...
									<div class="single-explore-txt bg-theme-2">
										<h2><a href="#"><?php echo $one_destination['nom']; ?></a></h2>
										<p class="explore-rating-price">
											<span class="explore-rating"><?php echo $one_destination['rating']; ?></span>
											<a href="#"> <?php echo $one_destination['ratings_count']; ?> ratings</a>
											<span class="explore-price-box">
                                                form
                                                <span class="explore-price"><?php echo $one_destination["prix"];?>$</span>
                                            </span>
											<a href="#"><?php echo $one_destination["nom_categorie"];?></a>
										</p>
										<div class="explore-person">
											<div class="row">
												...
												<div class="col-sm-10">
													<?php echo $one_destination["description"];?>
													</p>
												</div>
											</div>
										</div>
