...
$listCategories = $categories -> getAllCategoriesWithServiceCount();
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active  " href="../categories/liste_categries.php">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card mb-4">
            <div class="card-header pb-0 d-flex align-content-between justify-content-between">
              <h6>Liste des Categories </h6>
                ...
                <a class="btn btn-primary mb-0" href="ajouter_categoris.php"><i class="fas fa-plus"></i>&nbsp;&nbsp;cree nouveau Categorie </a>
                ...
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                        ...
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">NB. d'utilisateur</th>
                  ...
                  <tbody>
                    <?php
                    while ($oneCategorie = $listCategories->fetch()){


                    ?>
                    <tr>
                      <td>
                          <?php echo $oneCategorie["Categorie_id"]?>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1 single-list-topics-content">
                            <div class="single-list-topics-icon">
                                <p class="<?php echo $oneCategorie["image"] ?>"></p>
                            </div>
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 m-lg-2 "><?php echo $oneCategorie["nom_categorie"]?> </h6>

                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $oneCategorie["description"]?></p>

                      </td>
                      <td class="align-middle text-center text-sm">
                        <span class="badge badge-sm bg-gradient-success"><?php echo $oneCategorie["service_count"]?></span>
                      </td>
                      <td class="align-middle">
                        <a href="update_categoris.php?id=<?php echo $oneCategorie["Categorie_id"];?>"  class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Mdifier
                        </a>
                      </td>
                        <td class="align-middle">
                          <a href="?id=<?php echo $oneCategorie["Categorie_id"]?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                              supprimer
                          </a>
                      </td>
                    </tr>
