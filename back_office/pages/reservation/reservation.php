...
$all_reservation=$Reservation->getAllReservations();
...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active " href="../reservation/reservation.php">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder mb-0">Reservation</h6>
        </nav>
                  ...
                  <?php while ($one_reservation = $all_reservation->fetch()) {?>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          ...
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm"><?php echo $one_reservation['nom_utilisateur'];?></h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <p class="text-xs font-weight-bold mb-0"><?php echo $one_reservation['nom_service'];?></p>
                      ...
                      <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-bold"><?php echo $one_reservation['agence'];?></span>
                      </td>
                        <td class="align-middle text-center">
                            <span class="text-secondary text-xs font-weight-bold"><?php echo $one_reservation['destination_depart'];?></span>
                        </td>
                        <td class="align-middle text-center">
                            <span class="text-secondary text-xs font-weight-bold"><?php echo $one_reservation['destination_arriver'];?></span>
                        </td>
                        <td class="align-middle text-center">
                            <span class="text-secondary text-xs font-weight-bold"><?php echo $one_reservation['prix'];?></span>
                        </td>
                      <td class="align-middle">
                        ...
                        <td class="align-middle">
                            <a href="operation_reservation.php?idR=<?php echo $one_reservation['Reservation_Id'];?>&etat=valider" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                valider
                            </a>
                        </td>
                        <td class="align-middle">
                            <a href="operation_reservation.php?idR=<?php echo $one_reservation['Reservation_Id'];?>&etat=annuler" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                annuler
                            </a>
                        </td>
                    </tr>
