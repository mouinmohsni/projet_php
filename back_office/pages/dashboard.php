...
$all_agences=$Agence->getAllAgences();
$count_agences=$all_agences->rowCount();
...
$max_agences=$Agence->agenceMaxService();
...
$all_user_services= $Service ->getAllServicesForAdmin($user_role,$user_id,$limit,$offset);
$totalPages = ceil($count_services / $limit);
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      <div class="icon icon-shape  bg-transparent  text-center border-radius-2xl">
                      </div>
                      <h5 class="text-white font-weight-bolder mb-0 mt-3">
                       <?php echo $count_agences?>
                      </h5>
                      <span class="text-white text-sm">les agences </span>
                    </div>
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <h5 class="text-white font-weight-bolder mb-0 mt-3">
                       <?php echo $count_services?>
                      </h5>
                      <span class="text-white text-sm">Les services</span>
                    </div>
                ...
                <div class="card-body p-3 position-relative">
                  <div class="row">
                    <div class="col-8 text-start">
                      ...
                      <span class="text-white text-sm">les reservations</span>
                    </div>
        ...
        <div class="col-lg-6 col-12 mt-4 mt-lg-0">
          <div class="card shadow h-100">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">Les agences les plus actives </h6>
            </div>
            <div class="card-body pb-0 p-3">
              <ul class="list-group">
                  <?php

                  while ($agence= $max_agences->fetch()) {
                ...
                <li class="list-group-item border-0 d-flex align-items-center px-0 mb-0">
                  <div class="w-100">
                    <div class="d-flex mb-2">
                      <a href="agences/one_agence.php?id=<?php echo $agence['user_id'];?>"> <span class="me-2 text-sm font-weight-bold text-dark"><?php echo $agence["nom_agence"]; ?> </span></a>
                      <span class="ms-auto text-sm font-weight-bold"> Nb. Service : <?php echo $agence["nb_services"]; ?></span>
                    </div>
                    <div>
                      <div class="progress progress-md">
                        <div class="progress-bar bg-primary w-<?php echo $agence["nb_services"]; ?>" role="progressbar" aria-valuenow="<?php echo $agence["nb_services"]; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                </li>
            ...
            <div class="card-footer pt-0 p-3 d-flex align-items-center">
              ...
              <div class="w-40 text-end">
                <a class="btn btn-dark mb-0 text-end" href="agences/agence.php">les agences</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div class="card-body px-0 pt-0 pb-2">
                  <div class="table-responsive p-0">
                      <table class="table align-items-center mb-0 text-nowrap">
                          ...
                          <tbody>
                          <?php
                          while ($oneService = $all_user_services->fetch()){
